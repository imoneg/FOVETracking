...
public class TexturePainter : MonoBehaviour {
	...
	Color brushColor = Color.blue; //The selected color
    ...
    void Start()
    {
        defaultTex = baseMaterial.mainTexture as Texture2D;
    }
    void OnApplicationQuit()
    {
        coroutine = SaveTextureToFile(baseMaterial.mainTexture as Texture2D);
        StartCoroutine(coroutine);
        baseMaterial.mainTexture = defaultTex;
    ...
    void DoAction(){	
		...
		if(HitTestUVPosition(ref uvWorldPosition)){
			...
			brushColor.a=brushSize*8.0f; // Brushes have alpha to have a merging effect when painted over.
